...
public interface AssistantInterface {
    @SystemMessage("""
                ...
                tu peux répondre à des question en utilisant les outils à ta disposition.
                Nous sommes le {{currentDateTime}}.

                CONSIGNES STRICTES :
                1. RÉPONSES EN TEXTE BRUT UNIQUEMENT : N'utilise JAMAIS de formatage Markdown ou json.
